...
#if defined(STM32) || defined(CLEARCORE)	/** STM32 or ClearCore target -> uses a struct for the network interface */
...
#if defined(STM32) || defined(CLEARCORE)  /** STM32 or ClearCore target, the hostname is linked to the network interface */
/** @ingroup CIP_API
