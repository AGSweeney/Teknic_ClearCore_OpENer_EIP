...
CipIdentityObject g_identity = { .vendor_id = OPENER_DEVICE_VENDOR_ID, /* Attribute 1: Vendor ID */
                                 ...
                                 .state = kStateOperational, /* Attribute 8: State - Operational when running */
...
EipStatus CipIdentityInit() {
  ...
  OPENER_TRACE_INFO("CipIdentityInit: vendor_id=%d, device_type=%d, product_code=%d, revision=%d.%d\n",
                    g_identity.vendor_id, g_identity.device_type, g_identity.product_code,
