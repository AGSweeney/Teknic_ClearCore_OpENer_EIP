...
#include <string.h>
#include <stdlib.h>
#if !defined(STM32) && !defined(CLEARCORE)	/** Not STM32 or ClearCore target */
#include <errno.h>
#else	/** STM32 or ClearCore target (GCC), lwip has its own error code list */
#include "lwip/errno.h"
#endif	/* STM32 or ClearCore target */
...
#ifdef CLEARCORE
  struct udp_pcb *udp_unicast_listener; /**< UDP unicast listener PCB */
  struct udp_pcb *udp_global_broadcast_listener; /**< UDP global network broadcast listener PCB */
  struct udp_pcb *udp_io_messaging; /**< UDP IO messaging PCB */
#else
